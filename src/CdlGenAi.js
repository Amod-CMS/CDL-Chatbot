...
import AiBackendCall from './genAiBackend';

function Email() {
    return (
        <div className="Mail">
            <p>Thanks for using the CMSON, if you still have some queries, please mail it on <a href="mailto:demerger@cms.co.in" style={{ color: 'black' }}>demerger@cms.co.in</a> </p>
        </div>
    );
}
            ...
            <ThemeProvider theme={theme}>
                <Chatbot
                    ...
                    steps={[
                        ...
                        {
                            "id": "welcomeUser",
                            "message": "Hello {previousValue} 👋👋!, Pleases ask me your query ?",
                            "trigger": "whichQuery"
                        },
                        {
                            "id": "whichQuery",
                        ...
                        },
                        {
                            ...
                            trigger: 'fetchBackendResponse'
                        },
                        {
                            id: 'fetchBackendResponse',
                            component: <AiBackendCall />,
                            waitAction: true,
                            asMessage: true,
